...
import { CompleteOnboardingData, dietSchema } from "@shared/schema";
...
export default function DietStep({ onSubmit, initialData }: DietStepProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)}>
      <h3 className="text-lg font-semibold mb-3 dark:text-white">Diet</h3>
      <p className="text-neutral-600 dark:text-neutral-400 mb-4">Which best describes your typical diet?</p>
      ...
      {errors.dietType && (
        <p className="mt-2 text-sm text-red-500">Please select your diet type</p>
      )}
